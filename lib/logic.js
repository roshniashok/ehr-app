...
async function ElevatePermissionParamedics(elevatepermission) {
    elevatepermission.record.owner1 = elevatepermission.newOwner;
...
async function AddRecords(record) {
    ...
    recordAsset.age= record.age
  	...
  	console.log(record.prescription)
   	recordAsset.prescription=record.prescription
  	recordAsset.report=record.report
  	recordAsset.insurance=record.insurance
  	recordAsset.owner1 =record.owner1
  	recordAsset.owner2 =record.owner2
